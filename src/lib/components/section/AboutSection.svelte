...
<section class="pb-8">
    ...
    <div class="pr-8 shrink-0 text-white grid items-center justify-start mx-auto w-5/6 lg:w-2/4">
        ...
        <div class="flex flex-wrap justify-start gap-8">
            ...
            <SocialLink icon={faDiscord} link="https://discord.com/users/{Variables.DISCORD_ID}" name="Discord"/>

            <SocialLink icon={faEnvelope} link="mailto:{Variables.EMAIL}" name="Email"/>
        </div>
    </div>
</section>